# AWS Setup Instructions: Healthcare Knowledge Multi-Agent
...
| Item | Value |
|---|---|
| Project slug | `dstrmaysam-healthcare-knowledge-multi-agent` |
...
| OpenSearch index | `dstrmaysam-healthcare-knowledge-multi-agent` |
| DynamoDB table | `dstrmaysam-healthcare-knowledge-multi-agent-dev` |
| Backend ECR repo | `dstrmaysam-healthcare-knowledge-multi-agent-backend` |
| Frontend ECR repo | `dstrmaysam-healthcare-knowledge-multi-agent-frontend` |
| Backend ECS task family | `dstrmaysam-healthcare-knowledge-multi-agent-backend` |
| Frontend ECS task family | `dstrmaysam-healthcare-knowledge-multi-agent-frontend` |
| ECS execution role | `dstrmaysam-healthcare-knowledge-multi-agent-ecs-execution-role` |
| Backend task role | `dstrmaysam-healthcare-knowledge-multi-agent-backend-task-role` |
| Frontend task role | `dstrmaysam-healthcare-knowledge-multi-agent-frontend-task-role` |
| Backend log group | `/ecs/dstrmaysam-healthcare-knowledge-multi-agent/backend` |
| Frontend log group | `/ecs/dstrmaysam-healthcare-knowledge-multi-agent/frontend` |
...
aws s3api create-bucket \
  --bucket dstrmaysam-healthcare-knowledge-multi-agent-dev \
  --region eu-west-2 \
...
s3://dstrmaysam-healthcare-knowledge-multi-agent-dev/manifests/documents.json
```
...
| Field | Value |
|---|---|
| Table name | `dstrmaysam-healthcare-knowledge-multi-agent-dev` |
...
| Item | Value |
|---|---|
| Collection name | `dstrmaysam-healthcare-knowledge-multi-agent` |
| Collection type | Vector search |
| Index name | `dstrmaysam-healthcare-knowledge-multi-agent` |
...
OPENSEARCH_INDEX=dstrmaysam-healthcare-knowledge-multi-agent
```
...
aws ecr create-repository \
  --region eu-west-2 \
  --repository-name dstrmaysam-healthcare-knowledge-multi-agent-backend

aws ecr create-repository \
  --region eu-west-2 \
  --repository-name dstrmaysam-healthcare-knowledge-multi-agent-frontend
```

Images expected by the ECS templates:

```text
<account-id>.dkr.ecr.eu-west-2.amazonaws.com/dstrmaysam-healthcare-knowledge-multi-agent-backend:latest
<account-id>.dkr.ecr.eu-west-2.amazonaws.com/dstrmaysam-healthcare-knowledge-multi-agent-frontend:latest
```
...
docker build -t dstrmaysam-healthcare-knowledge-multi-agent-backend:latest backend
docker tag dstrmaysam-healthcare-knowledge-multi-agent-backend:latest <account-id>.dkr.ecr.eu-west-2.amazonaws.com/dstrmaysam-healthcare-knowledge-multi-agent-backend:latest
docker push <account-id>.dkr.ecr.eu-west-2.amazonaws.com/dstrmaysam-healthcare-knowledge-multi-agent-backend:latest

docker build -t dstrmaysam-healthcare-knowledge-multi-agent-frontend:latest frontend
docker tag dstrmaysam-healthcare-knowledge-multi-agent-frontend:latest <account-id>.dkr.ecr.eu-west-2.amazonaws.com/dstrmaysam-healthcare-knowledge-multi-agent-frontend:latest
docker push <account-id>.dkr.ecr.eu-west-2.amazonaws.com/dstrmaysam-healthcare-knowledge-multi-agent-frontend:latest
```
...
```text
dstrmaysam-healthcare-knowledge-multi-agent-ecs-execution-role
```
...
```text
dstrmaysam-healthcare-knowledge-multi-agent-backend-task-role
```
...
```text
dstrmaysam-healthcare-knowledge-multi-agent-frontend-task-role
```
...
aws logs create-log-group \
  --region eu-west-2 \
  --log-group-name /ecs/dstrmaysam-healthcare-knowledge-multi-agent/backend

aws logs create-log-group \
  --region eu-west-2 \
  --log-group-name /ecs/dstrmaysam-healthcare-knowledge-multi-agent/frontend
```
...
|---|---|---|---|
| `dstrmaysam-healthcare-knowledge-multi-agent-backend` | backend task definition | `1` or more | private subnets |
| `dstrmaysam-healthcare-knowledge-multi-agent-frontend` | frontend task definition | `1` or more | private subnets |
...
python evals/run_ragas_eval.py \
  ...
  --aws-region eu-west-2 \
  --secrets-stage dev \
  --eval-run-name dstrmaysam-healthcare-knowledge-multi-agent-ragas-eval
```
...
- Create S3 bucket `dstrmaysam-healthcare-knowledge-multi-agent-dev`.
- Create DynamoDB table `dstrmaysam-healthcare-knowledge-multi-agent-dev`.
- Create Secrets Manager secrets under `/dstrmaysam-healthcare-knowledge-multi-agent/dev/...`.
