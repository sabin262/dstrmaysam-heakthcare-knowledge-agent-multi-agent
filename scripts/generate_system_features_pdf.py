...
OUTPUT = ROOT / "docs" / "dstrmaysam_healthcare_knowledge_multi_agent_system_features.pdf"
...
def add_title(pdf: SimplePdf) -> None:
    pdf.text("Healthcare Knowledge Multi-Agent", size=20, font="F2", y=720)
...
def build() -> None:
    pdf = SimplePdf("Healthcare Knowledge Multi-Agent - System Feature Guide")
    add_title(pdf)
