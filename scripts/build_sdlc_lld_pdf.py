...
OUT_DIR = ROOT / "docs"
PDF_PATH = OUT_DIR / "dstrmaysam_healthcare_knowledge_multi_agent_lld_sdlc.pdf"
...
def header_footer(canvas, doc):
    ...
    canvas.drawString(
        inch,
        height - 0.55 * inch,
        "Healthcare Knowledge Multi-Agent - SDLC Low-Level Design",
    )
...
def story_cover():
    story = [
        Spacer(1, 1.15 * inch),
        p("Healthcare Knowledge Multi-Agent", "cover_title"),
...
def build_story():
    ...
    story.append(
        p(
            "The Healthcare Knowledge Multi-Agent is a containerized internal assistant for grounded healthcare "
    ...
    story.extend(
        table(
            [
                ...
                ["Images", "ECR", "`dstrmaysam-healthcare-knowledge-multi-agent-backend`, `...-frontend`."],
                ["Documents", "S3", "`dstrmaysam-healthcare-knowledge-multi-agent-dev`, raw docs and manifest."],
                ["Vector search", "OpenSearch Serverless", "Index `dstrmaysam-healthcare-knowledge-multi-agent` with 1536-dim vectors."],
                ["History", "DynamoDB", "Table `dstrmaysam-healthcare-knowledge-multi-agent-dev`."],
                ["Secrets", "AWS Secrets Manager", "`/dstrmaysam-healthcare-knowledge-multi-agent/dev/{app,azure-openai,langfuse}`."],
                ["Logs", "CloudWatch Logs", "`/ecs/dstrmaysam-healthcare-knowledge-multi-agent/backend` and `/frontend`."],
...
def build_pdf() -> Path:
    ...
    doc = BaseDocTemplate(
        ...
        title="Healthcare Knowledge Multi-Agent SDLC Low-Level Design",
        author="OpenAI Codex",
